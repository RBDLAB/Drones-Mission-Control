...
namespace SRL
{
	...
	public:
		Serial(std::string commPortName, int parity, int dataBits, int flowControl, int stopBits, int inputBufferSize, int binary, int timeOut, int readAsync, int bitRate = 115200);
